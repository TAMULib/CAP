...
==== Request Fields
include::../../../target/generated-snippets/create-repository-view/request-fields.adoc[]

==== Sample Request
include::../../../target/generated-snippets/create-repository-view/http-request.adoc[]

==== Sample Response
include::../../../target/generated-snippets/create-repository-view/http-response.adoc[]
