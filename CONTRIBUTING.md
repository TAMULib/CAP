<a name="readme-top"></a>
# Contributing to Curator's Administration Platform

Though *Curator's Administration Platform (CAP)* is developed and maintained by Texas A&M University Libraries, we welcome community contributions.
Involvement in *CAP* can take many forms.
...
Deploying *CAP* and trying it out at your own institution is itself a way of contributing to the development process.
...
Once you are using *CAP* the creation of new issues through GitHub is a major method of contribution towards *CAP* development.
...
Each *PR* will need to be reviewed by a *CAP* developer.
...
If you have any additional questions please contact the *CAP* developers at helpdesk@library.tamu.edu.
